...
- **Code**: Changed all <code>React.JSX.Element</code> to <code>React.ReactElement</code>
...
- **Change Log**: Fixed bug of which the Regex will only replace one <code>code</code> tag in each entry
