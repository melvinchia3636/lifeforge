...
- <Commit hash="33b50c16de27d918061524e57d86fe601c88be3f" />: Removed `corsAllowedOrigins.example.ts` file, leaving only `corsAllowedOrigins.ts` with a default value of `['http://localhost:5173']` for local development. Users can now directly modify this file to add their own allowed origins without the need to copy from an example file.
...
- <Commit hash="59d7ae51726b13da780c0c981086691ee033db72" />: Log files are now stored in the `logs/` directory at the root of the project instead of inside the `server/` directory.
- <Commit hash="bbb285f2bde6b7cba918beca1ab0c07e1fb40f2b" />: The `database/` directory is now kept in the git repository of the project (with empty .gitkeep file) that serves as a placeholder for database executable and data files. By default (if they ), users are required to manually place the PocketBase executable in this directory for the server to function properly.
...
- <Commit hash="cb824e027c50f6b4daedcd3a13c35f9521a41cf8" />: Added `wrapperClassName` prop to `SliderInput` component for easier customization of the wrapper element.
- <Commit hash="00dd6d435ba854c8185d279371a8b59ffa0dbf5f" />: Removed unnecessary div wrapper in `WithMasterPassword` component.
- <Commit hash='6fe5171c9f2c6ccaeea211c74616a64e268814df' />, <Commit hash="e51d77c6bd515cbca206c4019122b6f2b27137a3" />: Improved styling for the `EmptyStateScreen` component.
- <Commit hash="a03154bb354be005755c6a88131ed9b63f8363cc" />: Replaced independent API key existence checking API endpoints with the unified `forgeAPI.apiKeys.entries.checkKeys` endpoint.
- <Commit hash="5b774c91d7184938801246657611aa5318b71dff" />: Updated `VITE_API_HOST` and `PORT` environment variables with default values in the example environment files.
- <Commit hash="228a3ecdcd54991c785b400cac69b708b9160e06" />: Removed unused `VITE_GOOGLE_MAPS_API_KEY` environment variable from the example environment files.
...
- <Commit hash="53323d73a2d7fbb0bd73c02857c6e8ca39df3c55" />: Changed the method properties of the `PBService` class to getters to ensure proper scoping.
...
- <Commit hash="b8a09212f337cc8633c5638a928cdabbab086573" />: Bumped `@tanstack/react-query` to its latest version, as well as `react` and `react-dom` to version 19.2.0 across the codebase.
...
- <Commit hash="56a56ed0cb379e3a9152ca91b33ee1e4dd5627ee" />, <Commit hash="99c865d5dbafc66bee1bac8acd512d0d973ffb93" />: Fixed a bug in the `LocationInput` component where the location query is called even when the API key is not present in the vault.
- <Commit hash="ce94335e3a75c397e3be1013a6360d3e6fcd3583" />, <Commit hash="a5a5a5bb02b8da0ea5567be946763619f6c21c63" />: Added `NuqsProvider` wrapper in the `shared` library to ensure proper functioning of the Nuqs library.
- <Commit hash="f5f07232db47519790df92d8ee7ba023bdedcbe9" />: Fixed the localization for new password confirmation modal in `CreatePasswordScreen` component.
...
- <Commit hash="b9a39066feba87411e36a2ba9c5cb4142aed6f50" />: Removed base config file extension from `tsconfig.json` of UI packages.
- <Commit hash="58ce44dfba4db8f29154f047e51a4e7cd0d73a25" />: Fixed a bug where the `userData` state is not updated when user perform a change in the personalization settings.
- <Commit hash="94e898e18e5d2a9960e21d91709bb2388d24a6c0" />: Bumped the version of `i18next` package to the latest version across the codebase.
...
- <Commit hash="40f3de4ef86681389f6f786d2049157d86f0abc4" />: Utilized the `commander` library in the `forge` script for better command-line argument parsing and handling.
- <Commit hash="0a677d67b4fae3e362ca46153826ff408c47b960" />, <Commit hash="6aa4a966ab9295e30ae2a3a3c60ecac8fd2d904f" />: Added a bash script `commit-all-modules.sh` to facilitate bulk committing changes across all module repositories.
- <Commit hash="2266ae23e374ac45d231a05111266016741ff371" />: Implemented `dev` script in forgeCLI to facilitate local development of modules. Refactored the entire `forge` script, separating the script from one fat file into multiple command files for better maintainability.
- <Commit hash="58b2dd00ce8891fd8d1e9bff3d29d204981d4f60" />: Running `dev` script will now kill any existing instances before starting a new one to prevent port conflicts.
- <Commit hash="081a02b272bba8f93a9cd865b6a40cbde2a3955a" />, <Commit hash="a92322fbe8f9ea8abbf373fdfd3d21b9cc9f7a11" />, <Commit hash='4e2c31a3bb6dafc2f08ba4139caff42aee171cf6' />, <Commit hash="1b0327b6f91d78ec10bd9264f6995dc1ae4825f2" />: Mechanism to add, remove, and list modules via CLI is now implemented in ForgeCLI. Integrated database schema and migration script into forgeCLI. Logging is also improved for better readability.
  ...
  ```bash
  pnpm forge module add <author>/<moduleName>
  pnpm forge module remove <moduleName>
  pnpm forge module list

  pnpm forge db generate-schema
  pnpm forge db generate-migrations
  ```
...
- <Commit hash="f3d16f05247e1867093195a1b91877c4f5e6a5fe" />, <Commit hash="a97697cc22d8afb98f66466412ad31172786d94e" />, <Commit hash="9c44e06bcd34e5318807b1d72c9bff7dc46cff78" />, <Commit hash="be756c8f57e13babcd9038733c25e1c6f06b6316" />: Added database initialization command in ForgeCLI to facilitate setting up the database for new installations. It can be run using:
  ...
  ```bash
  pnpm run forge db init
  ```

  For more information, refer to the [Configuration Guide](/getting-started/configuration).
- <Commit hash="6b5dfa8bbfec77325c0d2a55c672482eee91f110" />: Added build commands for shared and UI packages if the `dist/` directories are missing when starting client application.
