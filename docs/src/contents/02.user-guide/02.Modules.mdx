...
```bash
pnpm forge modules install <module-name>
```
...
```bash
pnpm forge modules install lifeforge--calendar lifeforge--todo-list lifeforge--idea-box
```
...
```bash
pnpm forge modules upgrade lifeforge--calendar
```

**Check all modules for updates:**
```bash
pnpm forge modules upgrade
```
...
```bash
pnpm forge modules uninstall <author>--<module-name>
```
...
```bash
pnpm forge modules uninstall lifeforge--calendar
```
...
```bash
pnpm forge modules uninstall lifeforge--calendar lifeforge--todo-list lifeforge--idea-box
```
...
```bash
pnpm forge modules uninstall <module-name>
pnpm forge modules install <full-module-name>
```
...
3. Try running `pnpm forge modules list` to verify the module is installed
...
|---------------------|---------|---------|
| List installed modules | `pnpm forge modules list` | `ls` |
| Install a module | `pnpm forge modules install <author>--<module>` | `i`, `add` |
| Uninstall a module | `pnpm forge modules uninstall <author>--<module>` | `un`, `rm`, `remove` |
| Update a specific module | `pnpm forge modules upgrade <author>--<module>` | `up`, `u` |
| Check all modules for updates | `pnpm forge modules upgrade` | `up`, `u` |
...
<Alert className="mt-6" type="tip">
  **Pro tip:** Use aliases to save time! For example:
  - `pnpm forge modules i lifeforge--calendar` instead of `install`
  - `pnpm forge modules rm lifeforge--calendar` instead of `uninstall`
  - `pnpm forge modules up` instead of `upgrade`
</Alert>
