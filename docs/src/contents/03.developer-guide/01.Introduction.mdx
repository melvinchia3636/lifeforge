...
- <div className="text-bg-800 dark:text-bg-100 flex items-center gap-2">
    <Icon icon="simple-icons:typescript" className="translate-y-1" />
...
- <div className="text-bg-800 dark:text-bg-100 flex items-center gap-2">
    <Icon icon="tabler:files" className="translate-y-1" />
    **Monorepo**
  </div>
...
- <div className="text-bg-800 dark:text-bg-100 flex items-center gap-2">
    <Icon icon="simple-icons:react" className="translate-y-1" />
    **React**
  </div>
...
- <div className="text-bg-800 dark:text-bg-100 flex items-center gap-2">
    <Icon icon="simple-icons:express" className="translate-y-1" />
    **ExpressJS**
  </div>
...
- <div className="text-bg-800 dark:text-bg-100 flex items-center gap-2">
    <Icon icon="simple-icons:tailwindcss" className="translate-y-1" />
    **TailwindCSS**
  </div>
  ...
  important.
- <div className="text-bg-800 dark:text-bg-100 flex items-center gap-2">
    <Icon icon="simple-icons:storybook" className="translate-y-1" />
    **Storybook**
  </div>
