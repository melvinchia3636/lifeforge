      ...
      className={clsx(
        customWidth ??
          (type === 'listbox'
            ? 'w-[var(--button-width)]'
            : 'w-[var(--input-width)]'),
        'z-9999 divide-bg-200 border-bg-200 dark:border-bg-700 divide-y overflow-auto rounded-md border',
        ...
        'focus:outline-hidden data-closed:scale-95 data-closed:opacity-0 dark:divide-bg-700/50 dark:border-bg-700 dark:bg-bg-800 empty:invisible'
      )}
    >
      {children}
    </Element>
