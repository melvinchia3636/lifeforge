...
<Warning className="mb-6">
  <p>
    ...
    of this documentation is extremely outdated and incomplete for now. Me being
    a solo developer, I am trying my best to keep up with the documentation while
    also working on the codebase.
  </p>
  <p>
    Thank you for your interest in LifeForge, and I apologize for the
    inconvenience. Please note that the documentation on installation and 
    configuration will not be updated until the system is more stable and the 
    architecture is finalized. Hopefully, this will happen in the next few months. 
    In the meantime, for those who are experienced with web development, you can still 
    explore the codebase and any form of contribution is highly appreciated.
  </p>
  <p>
