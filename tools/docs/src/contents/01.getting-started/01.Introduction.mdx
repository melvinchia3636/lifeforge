...
<Warning className="mb-6">
  <p>
    ...
    a solo developer, I am trying my best to keep up with the documentation
    while also working on the codebase.
  </p>
  <p>
    ...
    architecture is finalized. Hopefully, this will happen in the next few
    months. In the meantime, for those who are experienced with web development,
    you can still explore the codebase and any form of contribution is highly
    appreciated.
  </p>
  <p>
