...
const PhotosProvider = lazy(
  async () => await import('@modules/Photos/providers/PhotosProvider')
)
...
const ProjectsMProvider = lazy(
  async () => await import('@modules/ProjectsM/providers/ProjectsMProvider')
)
const Kanban = lazy(async () => await import('@modules/ProjectsM/pages/Kanban'))
...
const PasswordsProvider = lazy(
  async () => await import('@modules/Passwords/providers/PasswordsProvider')
)
...
const Wallet = lazy(async () => await import('@modules/Wallet/pages/Dashboard'))
...
const WalletProvider = lazy(
  async () => await import('@modules/Wallet/providers/WalletProvider')
)
...
const CFOPAlgorithms = lazy(async () => await import('@modules/CFOPAlgorithms'))
const CFOPF2L = lazy(
