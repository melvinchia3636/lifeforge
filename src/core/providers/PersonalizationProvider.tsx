import { hexToRgba, hsvaToRgba, rgbaToHsva } from '@uiw/color-convert'
...
import THEME_COLOR_HEX from './PersonalizationProvider/constants/theme_color_hex'
...
async function updateUserData(
  data: Record<string, string | IBackdropFilters | DashboardLayoutType>
): Promise<void> {
  try {
...
export default function PersonalizationProvider({
  ...
  useEffect(() => {
    ...
    if (rawThemeColor.startsWith('#')) {
      interpolateColors(rawThemeColor, 'theme')
    }
