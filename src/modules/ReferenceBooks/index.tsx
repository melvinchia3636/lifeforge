  ...
  return (
    <section className="flex h-full min-h-0 w-full flex-1 flex-col px-12">
      ...
      <div className="mb-12 mt-8 flex min-h-0 w-full flex-1">
        <aside className="h-full w-1/4 overflow-y-scroll rounded-lg bg-bg-50 py-4 dark:bg-bg-800/50">
        ...
        <div className="ml-12 flex h-full min-h-0 flex-1 flex-col">
          ...
          <search className="mt-6 flex w-full items-center gap-4 rounded-lg bg-bg-50 p-4 dark:bg-bg-800/50">
          ...
          <ul className="mt-6 grid min-h-0 grid-cols-3 gap-6 gap-y-12 overflow-y-auto">
            {Array(10)
              ...
              .map((_, i) => (
                ...
                >
                  <div className="flex h-72 w-full items-center justify-center rounded-lg bg-bg-50 p-8 dark:bg-bg-800/50">
                    <img
