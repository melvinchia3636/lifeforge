...
function Sidebar({
  ...
  return (
    <aside
      ...
      } top-0 z-[9999] h-full w-full shrink-0 overflow-y-scroll rounded-lg bg-bg-50 py-4 shadow-custom duration-300 dark:bg-bg-900 xl:static xl:h-[calc(100%-2rem)] xl:w-3/12`}
    >
