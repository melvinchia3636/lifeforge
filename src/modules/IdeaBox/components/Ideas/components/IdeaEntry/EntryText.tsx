...
function EntryText({
  ...
  return (
    <div className="group relative my-4 flex items-start justify-between gap-2 rounded-lg bg-bg-50 p-4 shadow-[4px_4px_10px_0px_rgba(0,0,0,0.05)] dark:bg-bg-900">
      {entry.pinned && (
        <Icon
          icon="tabler:pin"
