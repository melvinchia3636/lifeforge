...
function NotesInput({
  ...
  return (
    <div
      ...
      className="group relative mt-4 flex items-center gap-1 rounded-t-lg border-b-2 border-bg-500 bg-bg-200/50 focus-within:!border-custom-500 hover:bg-bg-200 dark:bg-bg-800/50 dark:hover:bg-bg-700"
    >
      <Icon
