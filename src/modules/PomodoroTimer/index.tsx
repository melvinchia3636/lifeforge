  ...
  return (
    <section className="flex h-full min-h-0 w-full flex-1 flex-col px-12">
      ...
      <div className="mt-8 flex w-full flex-1">
        <Timer />
        <aside className="mb-12 w-2/6 overflow-y-scroll rounded-lg bg-bg-50 p-6 dark:bg-bg-800/50">
          <h1 className="mb-2 flex items-center gap-2 text-2xl font-semibold">
            <Icon icon="tabler:circle-check" className="text-3xl" />
            <span className="ml-2">Things to do</span>
          </h1>
          <ul className="mt-6 flex flex-col gap-4">
            <li className="flex items-center justify-between gap-4 rounded-lg border-l-4 border-indigo-500 bg-bg-100 p-4 px-6 shadow-[4px_4px_10px_0px_rgba(0,0,0,0.05)] dark:bg-bg-800/50">
            ...
            <li className="flex items-center justify-between gap-4 rounded-lg border-l-4 border-orange-500 bg-bg-100 p-4 px-6 shadow-[4px_4px_10px_0px_rgba(0,0,0,0.05)] dark:bg-bg-800/50">
              <div className="flex flex-col gap-1">
