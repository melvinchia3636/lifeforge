...
function NotesFile(): React.ReactElement {
  ...
  return (
    ...
    //             </div>
    //             <div className="flex items-center gap-4">
    //               <button className="hidden rounded-lg p-4 text-bg-500 transition-all hover:bg-bg-100 hover:text-bg-800 dark:hover:bg-bg-700/50 dark:hover:text-bg-50 md:block">
