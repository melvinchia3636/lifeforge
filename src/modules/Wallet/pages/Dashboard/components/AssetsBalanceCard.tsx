              ...
              <ul className="mt-6 flex h-full flex-col gap-4">
                {assets.map(asset => (
                  <Link
                    ...
                    className="flex w-full min-w-0 flex-1 flex-col flex-between gap-4 rounded-lg bg-bg-100 p-6 shadow-[4px_4px_10px_rgba(0,0,0,0.1)] transition-all hover:bg-bg-200 dark:bg-bg-800 dark:hover:bg-bg-700/50 [@media(min-width:400px)]:flex-row"
                  >
