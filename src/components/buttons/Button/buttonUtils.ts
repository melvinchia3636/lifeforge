...
export const generateColorClass = (isRed: boolean, variant: string): string => {
  ...
  switch (variant) {
    ...
    case 'no-bg':
      return 'hover:bg-bg-200/50 dark:hover:bg-bg-800/50 text-bg-500 hover:text-bg-800 dark:hover:text-bg-50 disabled:text-bg-200'
    case 'secondary':
    default:
      return 'bg-bg-300 shadow-custom text-bg-500 dark:text-bg-50 dark:bg-bg-600 hover:bg-bg-400/50 dark:hover:bg-bg-500/80'
  }
}
