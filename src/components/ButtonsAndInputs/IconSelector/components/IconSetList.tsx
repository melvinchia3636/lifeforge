...
export default function IconSetList({
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col pb-2 pt-0">
              ...
              ([category, iconSets], index) =>
                Boolean(
                  ...
                  <div key={category} className="mb-6 w-full overflow-hidden">
                    ...
                    <div className="icon-list grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] flex-wrap gap-4">
                      {iconSets.map(
                        iconSet =>
                          (!iconFilterTerm.trim() ||
                            iconSet.name
                              .toLowerCase()
                              .includes(
                                iconFilterTerm.trim().toLowerCase()
                              )) && (
                            <button
                              key={iconSet.prefix}
                              type="button"
