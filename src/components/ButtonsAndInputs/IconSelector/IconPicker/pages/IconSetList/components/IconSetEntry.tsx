...
function IconSetEntry({
  ...
  return (
    <button
      ...
      className="flex w-full grow flex-col overflow-hidden rounded-md bg-white shadow-custom transition-all hover:bg-bg-50 dark:bg-bg-800 dark:hover:bg-bg-700/50"
    >
