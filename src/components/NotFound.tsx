...
function NotFound(): React.JSX.Element {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-6">
      <h1 className="text-[10rem] text-teal-500">;-;</h1>
      ...
      <div className="mt-6 flex items-center gap-4">
        <Link
          to="/"
          className="flex items-center rounded-lg bg-teal-500 px-6 py-4 font-medium uppercase tracking-widest text-white shadow-[4px_4px_10px_0px_rgba(0,0,0,0.05)] hover:bg-teal-600"
        >
