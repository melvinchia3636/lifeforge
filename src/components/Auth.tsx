...
function Auth(): React.JSX.Element {
  ...
  return (
    <>
      <section className="flex h-full w-full flex-col items-center justify-center px-12 lg:w-1/2">
        ...
        >
          <div className="group relative flex items-center gap-1 rounded-t-lg border-b-2 border-neutral-500 bg-neutral-800 focus-within:border-custom-500">
            <Icon
              icon="tabler:user"
              className="ml-6 h-6 w-6 shrink-0 text-neutral-100 group-focus-within:text-custom-500"
            />

            <div className="flex w-full items-center gap-2">
              <span
                className={`pointer-events-none absolute left-[4.2rem] font-medium tracking-wide text-neutral-100 group-focus-within:text-custom-500 ${
              ...
              <input
                ...
                className="mt-6 h-8 w-full rounded-lg bg-transparent p-6 pl-4 tracking-widest placeholder:text-transparent focus:outline-none focus:placeholder:text-neutral-100"
              />
            </div>
          </div>
          <div className="group relative flex items-center gap-1 rounded-t-lg border-b-2 border-neutral-500 bg-neutral-800 focus-within:border-custom-500">
            ...
            <div className="flex w-full items-center gap-2">
              ...
              <input
                ...
                placeholder="••••••••••••••••••••"
                className="mt-6 h-8 w-full rounded-lg bg-transparent p-6 pl-4 text-xl tracking-widest placeholder:text-transparent focus:outline-none focus:placeholder:text-neutral-100"
              />
            </div>
          </div>
          <div className="mt-6 flex flex-col gap-6">
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 rounded-lg bg-neutral-800 p-6 font-semibold uppercase tracking-widest transition-all hover:bg-neutral-700"
            >
