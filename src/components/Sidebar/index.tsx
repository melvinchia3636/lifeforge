    ...
    <aside
      className={`${
        sidebarExpanded
          ...
          : 'w-0 sm:w-[5.4rem]'
      } absolute left-0 top-0 z-[9990] flex h-full shrink-0 flex-col overflow-hidden rounded-r-2xl bg-bg-50 shadow-custom transition-all duration-300 dark:bg-bg-900 lg:relative`}
    >
