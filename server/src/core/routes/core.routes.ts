...
const coreRoutes = forgeRouter({
  '': welcome,
  locales: (await import('@apps/locales')).default,
  user: (await import('@apps/user')).default,
  apiKeys: (await import('@apps/apiKeys')).default,
  pixabay: (await import('@apps/pixabay')).default,
  locations: (await import('@apps/locations')).default,
  modules: (await import('@apps/modules')).default,
  backups: (await import('@apps/backups')).default,
  database: (await import('@apps/database')).default,
  ping,
  status,
  getRoot,
  media: getMedia,
