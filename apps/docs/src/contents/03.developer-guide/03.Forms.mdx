...
<div className="flex-center w-full mt-12">
    <img src="/assets/developer-forms/form.png" alt="" className="w-full rounded-lg" />
</div>
...
<section id="building-a-form">
  ...
  <Note>
  The <code>FormModal</code> component should be the only thing being returned by the modal component.
  </Note>
  ...
  - <div className="text-lg!"><code className="text-lg!">icon</code> & <code className="text-lg!">title</code></div> 
    ...
    ![form-header](/assets/developer-forms/formHeader.png)
  ...
  - <code className="text-lg!">submitButton</code>
    ...
    ![form-btn-create](/assets/developer-forms/btnCreate.png)

    ![form-btn-update](/assets/developer-forms/btnUpdate.png)
  ...
  - <code className="text-lg!">actionButton</code>
    ...
    ![form-btn-action](/assets/developer-forms/actionBtn.png)
  ...
  - <code className="text-lg!">loading</code>
    ...
    ![form-loading](/assets/developer-forms/formLoading.png)
  ...
  ![types-map-intellisense](/assets/developer-forms/typesMapIntellisense.png)
  </Note>
  ...
  ![setup-fields-intellisense](/assets/developer-forms/setupFields.png)
  </Note>
  ...
  ![auto-focus-field-intellisense](/assets/developer-forms/autofocus.png)
  </Note>
